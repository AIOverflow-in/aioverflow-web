...
const HeroHeader = () => {
  return (
    <section>
      <div className="relative grid w-full bg-prim h-96 lg:h-[32rem] place-items-center">
      ...
      <svg className="fill-prim" viewBox="0 0 1440 57" fill="none" xmlns="http://www.w3.org/2000/svg">
